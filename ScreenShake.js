...
// This is a quadratic function that return 0 at first,
// then return 0.5 when t=0.5, then return 0 when t=1.
...
export default class ScreenShake {
    constructor(camera) {
        ...
        // update() must be called in the loop function of the renderer,
